...
const TeamMemberCard = ({ name, jobPosition, description }) => {
    return (
        <div class="items-center bg-gray-900 rounded-lg shadow sm:flex dark:bg-gray-900 dark:border-gray-700">
            <a href="#">
            ...
            <div class="p-5">
                ...
                <span class="text-gray-500 dark:text-gray-400">{ jobPosition }</span>
